...
subtitle: "Interactive browser for T2D genetic associations with 21 insulin sensitivity indices"
format:
  dashboard:
    scrolling: true
    theme: cosmo
    nav-buttons:
      - icon: github
        href: https://github.com/USERNAME/isi_t2d_nat_24
execute:
  echo: false
  warning: false
  message: false
...
IS_INDEX_ORDER = [
  ...
  "inv-FIns/FGlu", "ISI basal", "Bennett SI", "Avignon SI0",
